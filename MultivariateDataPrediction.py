...
def fit_lstm(n_epoch):
    ...
    # fit network
    history = model.fit(train_X, train_y, epochs=n_epoch, batch_size= 72, validation_data=(test_X, test_y), verbose=2,
                        shuffle=False)
...
plt.plot(epochs, results, color = 'blue')
# plt.plot(inv_y[:50])
# # plt.title("actual")
# # plt.figure(2)
